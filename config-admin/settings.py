...
CORS_ALLOW_ALL_ORIGINS = True  # Permitir todas as origens para API pública
...
# Connection Pool Settings para PostgreSQL - configuração simplificada
